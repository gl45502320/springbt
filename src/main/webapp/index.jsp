...
<body>
<div id="top"> </div>
<form id="login" name="login" action="${pageContext.request.contextPath}/login.long" method="post">
  <div id="center">
    ...
    <div id="center_middle">
      ...
      <div class="chknumber">
        ...
        </label><img width="50" height="30" src="getKaptcha.long" id="kaptchaImage" onclick="document.getElementById('kaptchaImage').src='getKaptcha.long?time='+(new Date()).getTime();"  />
      </div>
    </div>
